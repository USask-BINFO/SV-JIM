...
bcftools sort -o ${TRUVARI_DIR_B}/FromTPCall/tp-comp.sorted.vcf $TRUVARI_DIR_B/FromTPCall/tp-comp.vcf
bgzip -c ${TRUVARI_DIR_B}/FromTPCall/tp-comp.sorted.vcf > ${TRUVARI_DIR_B}/FromTPCall/tp-comp.sorted.vcf.gz
tabix ${TRUVARI_DIR_B}/FromTPCall/tp-comp.sorted.vcf.gz

bcftools sort -o ${TRUVARI_DIR_B}/FromTPCall/tp-base.sorted.vcf $TRUVARI_DIR_B/FromTPCall/tp-base.vcf
bgzip -c ${TRUVARI_DIR_B}/FromTPCall/tp-base.sorted.vcf > ${TRUVARI_DIR_B}/FromTPCall/tp-base.sorted.vcf.gz
tabix ${TRUVARI_DIR_B}/FromTPCall/tp-base.sorted.vcf.gz


#bcftools sort -o ${TRUVARI_DIR_B}/FromTPBase/tp-comp.sorted.vcf $TRUVARI_DIR_B/FromTPBase/tp-comp.vcf
#bgzip -c ${TRUVARI_DIR_B}/FromTPBase/tp-comp.sorted.vcf > ${TRUVARI_DIR_B}/FromTPBase/tp-comp.sorted.vcf.gz
#tabix ${TRUVARI_DIR_B}/FromTPBase/tp-comp.sorted.vcf.gz

#bcftools sort -o ${TRUVARI_DIR_B}/FromTPBase/tp-base.sorted.vcf $TRUVARI_DIR_B/FromTPBase/tp-base.vcf
#bgzip -c ${TRUVARI_DIR_B}/FromTPBase/tp-base.sorted.vcf > ${TRUVARI_DIR_B}/FromTPBase/tp-base.sorted.vcf.gz
#tabix ${TRUVARI_DIR_B}/FromTPBase/tp-base.sorted.vcf.gz
...
truvari bench -o $OUTPUT_DIR/Call/FromTPCall -f $REF_GENOME -b ${TRUVARI_DIR_A}/tp-comp.sorted.vcf.gz -c ${TRUVARI_DIR_B}/FromTPCall/tp-comp.sorted.vcf.gz -s 0 -S 0 --sizemax $MAX_SIZE -r $MAX_REF_DIST -p 0 -P $OVERLAP -C $MAX_REF_DIST
...
gunzip -c $OUTPUT_DIR/Call/FromTPCall/fn.gz > $OUTPUT_DIR/Call/FromTPCall/fn.vcf


truvari bench -o $OUTPUT_DIR/Call/FromTPBase -f $REF_GENOME -b ${TRUVARI_DIR_A}/tp-comp.sorted.vcf.gz -c ${TRUVARI_DIR_B}/FromTPCall/tp-base.sorted.vcf.gz -s 0 -S 0 --sizemax $MAX_SIZE -r $MAX_REF_DIST -p 0 -P $OVERLAP -C $MAX_REF_DIST
...
truvari bench -o $OUTPUT_DIR/Base/FromTPCall -f $REF_GENOME -b ${TRUVARI_DIR_A}/tp-base.sorted.vcf.gz -c ${TRUVARI_DIR_B}/FromTPCall/tp-comp.sorted.vcf.gz -s 0 -S 0 --sizemax $MAX_SIZE -r $MAX_REF_DIST -p 0 -P $OVERLAP -C $MAX_REF_DIST
