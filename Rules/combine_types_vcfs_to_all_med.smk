rule combine_all_callers_types_to_all_directory_Med:
        input:
                str(config["truvariResultsFolder"] + "/CuteSV-PAV-Sniffles-SVIM-SVIM-ASM/DEL/Med/summary.json"),
                str(config["truvariResultsFolder"] + "/CuteSV-PAV-Sniffles-SVIM-SVIM-ASM/INS/Med/summary.json"),
                str(config["truvariResultsFolder"] + "/CuteSV-PAV-Sniffles-SVIM-SVIM-ASM/INV/Med/summary.json")
        output:
                str(config["truvariResultsFolder"] + "/CuteSV-PAV-Sniffles-SVIM-SVIM-ASM/ALL/Med/tp-comp.sorted.vcf"),
...
rule combine_cuteSV_pav_types_to_all_directory_Med:
        input:
                str(config["truvariResultsFolder"] + "/CuteSV-PAV/DEL/Med/summary.json"),
                str(config["truvariResultsFolder"] + "/CuteSV-PAV/INS/Med/summary.json"),
                str(config["truvariResultsFolder"] + "/CuteSV-PAV/INV/Med/summary.json")
        output:
                str(config["truvariResultsFolder"] + "/CuteSV-PAV/ALL/Med/tp-comp.sorted.vcf"),
...
rule combine_pav_svim_types_to_all_directory_Med:
        input:
                str(config["truvariResultsFolder"] + "/PAV-SVIM/DEL/Med/summary.json"),
                str(config["truvariResultsFolder"] + "/PAV-SVIM/INS/Med/summary.json"),
                str(config["truvariResultsFolder"] + "/PAV-SVIM/INV/Med/summary.json")
        output:
                str(config["truvariResultsFolder"] + "/PAV-SVIM/ALL/Med/tp-comp.sorted.vcf"),
...
rule combine_pav_svim_asm_types_to_all_directory_Med:
        input:
                str(config["truvariResultsFolder"] + "/PAV-SVIM-ASM/DEL/Med/summary.json"),
                str(config["truvariResultsFolder"] + "/PAV-SVIM-ASM/INS/Med/summary.json"),
                str(config["truvariResultsFolder"] + "/PAV-SVIM-ASM/INV/Med/summary.json")
        output:
                str(config["truvariResultsFolder"] + "/PAV-SVIM-ASM/ALL/Med/tp-comp.sorted.vcf"),
...
rule combine_pav_sniffles_types_to_all_directory_Med:
        input:
                str(config["truvariResultsFolder"] + "/PAV-Sniffles/DEL/Med/summary.json"),
                str(config["truvariResultsFolder"] + "/PAV-Sniffles/INS/Med/summary.json"),
                str(config["truvariResultsFolder"] + "/PAV-Sniffles/INV/Med/summary.json")
        output:
                str(config["truvariResultsFolder"] + "/PAV-Sniffles/ALL/Med/tp-comp.sorted.vcf"),
...
rule combine_cuteSV_sniffles_svim_svim_asm_types_to_all_directory_Med:
        input:
                str(config["truvariResultsFolder"] + "/CuteSV-Sniffles-SVIM-SVIM-ASM/DEL/Med/Call/FromTPCall/summary.json"),
                str(config["truvariResultsFolder"] + "/CuteSV-Sniffles-SVIM-SVIM-ASM/INS/Med/Call/FromTPCall/summary.json"),
                str(config["truvariResultsFolder"] + "/CuteSV-Sniffles-SVIM-SVIM-ASM/DUP/Med/Call/FromTPCall/summary.json"),
                str(config["truvariResultsFolder"] + "/CuteSV-Sniffles-SVIM-SVIM-ASM/INV/Med/Call/FromTPCall/summary.json"),
                str(config["truvariResultsFolder"] + "/CuteSV-Sniffles-SVIM-SVIM-ASM/DEL/Med/Call/FromTPBase/summary.json"),
                str(config["truvariResultsFolder"] + "/CuteSV-Sniffles-SVIM-SVIM-ASM/INS/Med/Call/FromTPBase/summary.json"),
                str(config["truvariResultsFolder"] + "/CuteSV-Sniffles-SVIM-SVIM-ASM/DUP/Med/Call/FromTPBase/summary.json"),
                str(config["truvariResultsFolder"] + "/CuteSV-Sniffles-SVIM-SVIM-ASM/INV/Med/Call/FromTPBase/summary.json"),
                str(config["truvariResultsFolder"] + "/CuteSV-Sniffles-SVIM-SVIM-ASM/DEL/Med/Base/FromTPCall/summary.json"),
                str(config["truvariResultsFolder"] + "/CuteSV-Sniffles-SVIM-SVIM-ASM/INS/Med/Base/FromTPCall/summary.json"),
                str(config["truvariResultsFolder"] + "/CuteSV-Sniffles-SVIM-SVIM-ASM/DUP/Med/Base/FromTPCall/summary.json"),
                str(config["truvariResultsFolder"] + "/CuteSV-Sniffles-SVIM-SVIM-ASM/INV/Med/Base/FromTPCall/summary.json")
        output:
                str(config["truvariResultsFolder"] + "/CuteSV-Sniffles-SVIM-SVIM-ASM/ALL/Med/Call/FromTPCall/tp-comp.sorted.vcf"),
                ...
                str(config["truvariResultsFolder"] + "/CuteSV-Sniffles-SVIM-SVIM-ASM/ALL/Med/Call/FromTPBase/tp-comp.sorted.vcf"),
                ...
                str(config["truvariResultsFolder"] + "/CuteSV-Sniffles-SVIM-SVIM-ASM/ALL/Med/Base/FromTPCall/tp-comp.sorted.vcf"),
...
rule combine_all_read_callers_types_to_all_directory_Med:
        input:
                str(config["truvariResultsFolder"] + "/CuteSV-Sniffles-SVIM/DEL/Med/FromTPCall/summary.json"),
                str(config["truvariResultsFolder"] + "/CuteSV-Sniffles-SVIM/INS/Med/FromTPCall/summary.json"),
                str(config["truvariResultsFolder"] + "/CuteSV-Sniffles-SVIM/DUP/Med/FromTPCall/summary.json"),
                str(config["truvariResultsFolder"] + "/CuteSV-Sniffles-SVIM/INV/Med/FromTPCall/summary.json"),
                str(config["truvariResultsFolder"] + "/CuteSV-Sniffles-SVIM/DEL/Med/FromTPBase/summary.json"),
                str(config["truvariResultsFolder"] + "/CuteSV-Sniffles-SVIM/INS/Med/FromTPBase/summary.json"),
                str(config["truvariResultsFolder"] + "/CuteSV-Sniffles-SVIM/DUP/Med/FromTPBase/summary.json"),
                str(config["truvariResultsFolder"] + "/CuteSV-Sniffles-SVIM/INV/Med/FromTPBase/summary.json")
        output:
                str(config["truvariResultsFolder"] + "/CuteSV-Sniffles-SVIM/ALL/Med/FromTPCall/tp-comp.sorted.vcf"),
                ...
                str(config["truvariResultsFolder"] + "/CuteSV-Sniffles-SVIM/ALL/Med/FromTPBase/tp-comp.sorted.vcf"),
...
rule combine_cuteSV_svim_asm_types_to_all_directory_Med:
        input:
                str(config["truvariResultsFolder"] + "/CuteSV-SVIM-ASM/DEL/Med/summary.json"),
                str(config["truvariResultsFolder"] + "/CuteSV-SVIM-ASM/INS/Med/summary.json"),
                str(config["truvariResultsFolder"] + "/CuteSV-SVIM-ASM/DUP/Med/summary.json"),
                str(config["truvariResultsFolder"] + "/CuteSV-SVIM-ASM/INV/Med/summary.json"),
        output:
                str(config["truvariResultsFolder"] + "/CuteSV-SVIM-ASM/ALL/Med/tp-comp.sorted.vcf"),
...
rule combine_svim_svim_asm_types_to_all_directory_Med:
        input:
                str(config["truvariResultsFolder"] + "/SVIM-SVIM-ASM/DEL/Med/summary.json"),
                str(config["truvariResultsFolder"] + "/SVIM-SVIM-ASM/INS/Med/summary.json"),
                str(config["truvariResultsFolder"] + "/SVIM-SVIM-ASM/DUP/Med/summary.json"),
                str(config["truvariResultsFolder"] + "/SVIM-SVIM-ASM/INV/Med/summary.json")
        output:
                str(config["truvariResultsFolder"] + "/SVIM-SVIM-ASM/ALL/Med/tp-comp.sorted.vcf"),
...
rule combine_sniffles_svim_asm_types_to_all_directory_Med:
        input:
                str(config["truvariResultsFolder"] + "/Sniffles-SVIM-ASM/DEL/Med/summary.json"),
                str(config["truvariResultsFolder"] + "/Sniffles-SVIM-ASM/INS/Med/summary.json"),
                str(config["truvariResultsFolder"] + "/Sniffles-SVIM-ASM/DUP/Med/summary.json"),
                str(config["truvariResultsFolder"] + "/Sniffles-SVIM-ASM/INV/Med/summary.json")
        output:
                str(config["truvariResultsFolder"] + "/Sniffles-SVIM-ASM/ALL/Med/tp-comp.sorted.vcf"),
...
rule combine_cuteSV_svim_types_to_all_directory_Med:
        input:
                str(config["truvariResultsFolder"] + "/CuteSV-SVIM/DEL/Med/summary.json"),
                str(config["truvariResultsFolder"] + "/CuteSV-SVIM/INS/Med/summary.json"),
                str(config["truvariResultsFolder"] + "/CuteSV-SVIM/DUP/Med/summary.json"),
                str(config["truvariResultsFolder"] + "/CuteSV-SVIM/INV/Med/summary.json")
        output:
                str(config["truvariResultsFolder"] + "/CuteSV-SVIM/ALL/Med/tp-comp.sorted.vcf"),
...
rule combine_cuteSV_sniffles_types_to_all_directory_Med:
        input:
                str(config["truvariResultsFolder"] + "/CuteSV-Sniffles/DEL/Med/summary.json"),
                str(config["truvariResultsFolder"] + "/CuteSV-Sniffles/INS/Med/summary.json"),
                str(config["truvariResultsFolder"] + "/CuteSV-Sniffles/DUP/Med/summary.json"),
                str(config["truvariResultsFolder"] + "/CuteSV-Sniffles/INV/Med/summary.json")
        output:
                str(config["truvariResultsFolder"] + "/CuteSV-Sniffles/ALL/Med/tp-comp.sorted.vcf"),
...
rule combine_sniffles_svim_types_to_all_directory_Med:
        input:
                str(config["truvariResultsFolder"] + "/Sniffles-SVIM/DEL/Med/summary.json"),
                str(config["truvariResultsFolder"] + "/Sniffles-SVIM/INS/Med/summary.json"),
                str(config["truvariResultsFolder"] + "/Sniffles-SVIM/DUP/Med/summary.json"),
                str(config["truvariResultsFolder"] + "/Sniffles-SVIM/INV/Med/summary.json")
        output:
                str(config["truvariResultsFolder"] + "/Sniffles-SVIM/ALL/Med/tp-comp.sorted.vcf"),
...
rule combine_cuteSV_pav_svim_to_all_directory_Med:
        input:
                str(config["truvariResultsFolder"] + "/CuteSV-PAV-SVIM/DEL/Med/FromTPCall/summary.json"),
                str(config["truvariResultsFolder"] + "/CuteSV-PAV-SVIM/INS/Med/FromTPCall/summary.json"),
                str(config["truvariResultsFolder"] + "/CuteSV-PAV-SVIM/INV/Med/FromTPCall/summary.json"),
                str(config["truvariResultsFolder"] + "/CuteSV-PAV-SVIM/DEL/Med/FromTPBase/summary.json"),
                str(config["truvariResultsFolder"] + "/CuteSV-PAV-SVIM/INS/Med/FromTPBase/summary.json"),
                str(config["truvariResultsFolder"] + "/CuteSV-PAV-SVIM/INV/Med/FromTPBase/summary.json")
        output:
                str(config["truvariResultsFolder"] + "/CuteSV-PAV-SVIM/ALL/Med/FromTPCall/tp-comp.sorted.vcf"),
                ...
                str(config["truvariResultsFolder"] + "/CuteSV-PAV-SVIM/ALL/Med/FromTPBase/tp-comp.sorted.vcf"),
...
rule combine_pav_sniffles_svim_to_all_directory_Med:
        input:
                str(config["truvariResultsFolder"] + "/PAV-Sniffles-SVIM/DEL/Med/FromTPCall/summary.json"),
                str(config["truvariResultsFolder"] + "/PAV-Sniffles-SVIM/INS/Med/FromTPCall/summary.json"),
                str(config["truvariResultsFolder"] + "/PAV-Sniffles-SVIM/INV/Med/FromTPCall/summary.json"),
                str(config["truvariResultsFolder"] + "/PAV-Sniffles-SVIM/DEL/Med/FromTPBase/summary.json"),
                str(config["truvariResultsFolder"] + "/PAV-Sniffles-SVIM/INS/Med/FromTPBase/summary.json"),
                str(config["truvariResultsFolder"] + "/PAV-Sniffles-SVIM/INV/Med/FromTPBase/summary.json")
        output:
                str(config["truvariResultsFolder"] + "/PAV-Sniffles-SVIM/ALL/Med/FromTPCall/tp-comp.sorted.vcf"),
                ...
                str(config["truvariResultsFolder"] + "/PAV-Sniffles-SVIM/ALL/Med/FromTPBase/tp-comp.sorted.vcf"),
...
rule combine_pav_svim_svim_asm_to_all_directory_Med:
        input:
                str(config["truvariResultsFolder"] + "/PAV-SVIM-SVIM-ASM/DEL/Med/FromTPCall/summary.json"),
                str(config["truvariResultsFolder"] + "/PAV-SVIM-SVIM-ASM/INS/Med/FromTPCall/summary.json"),
                str(config["truvariResultsFolder"] + "/PAV-SVIM-SVIM-ASM/INV/Med/FromTPCall/summary.json"),
                str(config["truvariResultsFolder"] + "/PAV-SVIM-SVIM-ASM/DEL/Med/FromTPBase/summary.json"),
                str(config["truvariResultsFolder"] + "/PAV-SVIM-SVIM-ASM/INS/Med/FromTPBase/summary.json"),
                str(config["truvariResultsFolder"] + "/PAV-SVIM-SVIM-ASM/INV/Med/FromTPBase/summary.json")
        output:
                str(config["truvariResultsFolder"] + "/PAV-SVIM-SVIM-ASM/ALL/Med/FromTPCall/tp-comp.sorted.vcf"),
                ...
                str(config["truvariResultsFolder"] + "/PAV-SVIM-SVIM-ASM/ALL/Med/FromTPBase/tp-comp.sorted.vcf"),
...
rule combine_cuteSV_pav_sniffles_to_all_directory_Med:
        input:
                str(config["truvariResultsFolder"] + "/CuteSV-PAV-Sniffles/DEL/Med/FromTPCall/summary.json"),
                str(config["truvariResultsFolder"] + "/CuteSV-PAV-Sniffles/INS/Med/FromTPCall/summary.json"),
                str(config["truvariResultsFolder"] + "/CuteSV-PAV-Sniffles/INV/Med/FromTPCall/summary.json"),
                str(config["truvariResultsFolder"] + "/CuteSV-PAV-Sniffles/DEL/Med/FromTPBase/summary.json"),
                str(config["truvariResultsFolder"] + "/CuteSV-PAV-Sniffles/INS/Med/FromTPBase/summary.json"),
                str(config["truvariResultsFolder"] + "/CuteSV-PAV-Sniffles/INV/Med/FromTPBase/summary.json")
        output:
                str(config["truvariResultsFolder"] + "/CuteSV-PAV-Sniffles/ALL/Med/FromTPCall/tp-comp.sorted.vcf"),
                ...
                str(config["truvariResultsFolder"] + "/CuteSV-PAV-Sniffles/ALL/Med/FromTPBase/tp-comp.sorted.vcf"),
...
rule combine_cuteSV_pav_svim_asm_to_all_directory_Med:
        input:
                str(config["truvariResultsFolder"] + "/CuteSV-PAV-SVIM-ASM/DEL/Med/FromTPCall/summary.json"),
                str(config["truvariResultsFolder"] + "/CuteSV-PAV-SVIM-ASM/INS/Med/FromTPCall/summary.json"),
                str(config["truvariResultsFolder"] + "/CuteSV-PAV-SVIM-ASM/INV/Med/FromTPCall/summary.json"),
                str(config["truvariResultsFolder"] + "/CuteSV-PAV-SVIM-ASM/DEL/Med/FromTPBase/summary.json"),
                str(config["truvariResultsFolder"] + "/CuteSV-PAV-SVIM-ASM/INS/Med/FromTPBase/summary.json"),
                str(config["truvariResultsFolder"] + "/CuteSV-PAV-SVIM-ASM/INV/Med/FromTPBase/summary.json")
        output:
                str(config["truvariResultsFolder"] + "/CuteSV-PAV-SVIM-ASM/ALL/Med/FromTPCall/tp-comp.sorted.vcf"),
                ...
                str(config["truvariResultsFolder"] + "/CuteSV-PAV-SVIM-ASM/ALL/Med/FromTPBase/tp-comp.sorted.vcf"),
...
rule combine_pav_sniffles_svim_asm_to_all_directory_Med:
        input:
                str(config["truvariResultsFolder"] + "/PAV-Sniffles-SVIM-ASM/DEL/Med/FromTPCall/summary.json"),
                str(config["truvariResultsFolder"] + "/PAV-Sniffles-SVIM-ASM/INS/Med/FromTPCall/summary.json"),
                str(config["truvariResultsFolder"] + "/PAV-Sniffles-SVIM-ASM/INV/Med/FromTPCall/summary.json"),
                str(config["truvariResultsFolder"] + "/PAV-Sniffles-SVIM-ASM/DEL/Med/FromTPBase/summary.json"),
                str(config["truvariResultsFolder"] + "/PAV-Sniffles-SVIM-ASM/INS/Med/FromTPBase/summary.json"),
                str(config["truvariResultsFolder"] + "/PAV-Sniffles-SVIM-ASM/INV/Med/FromTPBase/summary.json")
        output:
                str(config["truvariResultsFolder"] + "/PAV-Sniffles-SVIM-ASM/ALL/Med/FromTPCall/tp-comp.sorted.vcf"),
                ...
                str(config["truvariResultsFolder"] + "/PAV-Sniffles-SVIM-ASM/ALL/Med/FromTPBase/tp-comp.sorted.vcf"),
...
rule combine_cuteSV_svim_svim_asm_to_all_directory_Med:
        input:
                str(config["truvariResultsFolder"] + "/CuteSV-SVIM-SVIM-ASM/DEL/Med/FromTPCall/summary.json"),
                str(config["truvariResultsFolder"] + "/CuteSV-SVIM-SVIM-ASM/INS/Med/FromTPCall/summary.json"),
                str(config["truvariResultsFolder"] + "/CuteSV-SVIM-SVIM-ASM/DUP/Med/FromTPCall/summary.json"),
                str(config["truvariResultsFolder"] + "/CuteSV-SVIM-SVIM-ASM/INV/Med/FromTPCall/summary.json"),
                str(config["truvariResultsFolder"] + "/CuteSV-SVIM-SVIM-ASM/DEL/Med/FromTPBase/summary.json"),
                str(config["truvariResultsFolder"] + "/CuteSV-SVIM-SVIM-ASM/INS/Med/FromTPBase/summary.json"),
                str(config["truvariResultsFolder"] + "/CuteSV-SVIM-SVIM-ASM/DUP/Med/FromTPBase/summary.json"),
                str(config["truvariResultsFolder"] + "/CuteSV-SVIM-SVIM-ASM/INV/Med/FromTPBase/summary.json")
        output:
                str(config["truvariResultsFolder"] + "/CuteSV-SVIM-SVIM-ASM/ALL/Med/FromTPCall/tp-comp.sorted.vcf"),
                ...
                str(config["truvariResultsFolder"] + "/CuteSV-SVIM-SVIM-ASM/ALL/Med/FromTPBase/tp-comp.sorted.vcf"),
...
rule combine_sniffles_svim_svim_asm_to_all_directory_Med:
        input:
                str(config["truvariResultsFolder"] + "/Sniffles-SVIM-SVIM-ASM/DEL/Med/FromTPCall/summary.json"),
                str(config["truvariResultsFolder"] + "/Sniffles-SVIM-SVIM-ASM/INS/Med/FromTPCall/summary.json"),
                str(config["truvariResultsFolder"] + "/Sniffles-SVIM-SVIM-ASM/DUP/Med/FromTPCall/summary.json"),
                str(config["truvariResultsFolder"] + "/Sniffles-SVIM-SVIM-ASM/INV/Med/FromTPCall/summary.json"),
                str(config["truvariResultsFolder"] + "/Sniffles-SVIM-SVIM-ASM/DEL/Med/FromTPBase/summary.json"),
                str(config["truvariResultsFolder"] + "/Sniffles-SVIM-SVIM-ASM/INS/Med/FromTPBase/summary.json"),
                str(config["truvariResultsFolder"] + "/Sniffles-SVIM-SVIM-ASM/DUP/Med/FromTPBase/summary.json"),
                str(config["truvariResultsFolder"] + "/Sniffles-SVIM-SVIM-ASM/INV/Med/FromTPBase/summary.json")
        output:
                str(config["truvariResultsFolder"] + "/Sniffles-SVIM-SVIM-ASM/ALL/Med/FromTPCall/tp-comp.sorted.vcf"),
                ...
                str(config["truvariResultsFolder"] + "/Sniffles-SVIM-SVIM-ASM/ALL/Med/FromTPBase/tp-comp.sorted.vcf"),
...
rule combine_cuteSV_sniffles_svim_asm_to_all_directory_Med:
        input:
                str(config["truvariResultsFolder"] + "/CuteSV-Sniffles-SVIM-ASM/DEL/Med/FromTPCall/summary.json"),
                str(config["truvariResultsFolder"] + "/CuteSV-Sniffles-SVIM-ASM/INS/Med/FromTPCall/summary.json"),
                str(config["truvariResultsFolder"] + "/CuteSV-Sniffles-SVIM-ASM/DUP/Med/FromTPCall/summary.json"),
                str(config["truvariResultsFolder"] + "/CuteSV-Sniffles-SVIM-ASM/INV/Med/FromTPCall/summary.json"),
                str(config["truvariResultsFolder"] + "/CuteSV-Sniffles-SVIM-ASM/DUP/Med/FromTPCall/summary.json"),
                str(config["truvariResultsFolder"] + "/CuteSV-Sniffles-SVIM-ASM/DEL/Med/FromTPBase/summary.json"),
                str(config["truvariResultsFolder"] + "/CuteSV-Sniffles-SVIM-ASM/INS/Med/FromTPBase/summary.json"),
                str(config["truvariResultsFolder"] + "/CuteSV-Sniffles-SVIM-ASM/DUP/Med/FromTPBase/summary.json"),
                str(config["truvariResultsFolder"] + "/CuteSV-Sniffles-SVIM-ASM/INV/Med/FromTPBase/summary.json"),
                str(config["truvariResultsFolder"] + "/CuteSV-Sniffles-SVIM-ASM/DUP/Med/FromTPBase/summary.json")
        output:
                str(config["truvariResultsFolder"] + "/CuteSV-Sniffles-SVIM-ASM/ALL/Med/FromTPCall/tp-comp.sorted.vcf"),
                ...
                str(config["truvariResultsFolder"] + "/CuteSV-Sniffles-SVIM-ASM/ALL/Med/FromTPBase/tp-comp.sorted.vcf"),
...
rule combine_cuteSV_pav_sniffles_svim_to_all_directory_Med:
        input:
                str(config["truvariResultsFolder"] + "/CuteSV-PAV-Sniffles-SVIM/DEL/Med/Call/FromTPCall/summary.json"),
                str(config["truvariResultsFolder"] + "/CuteSV-PAV-Sniffles-SVIM/INS/Med/Call/FromTPCall/summary.json"),
                str(config["truvariResultsFolder"] + "/CuteSV-PAV-Sniffles-SVIM/INV/Med/Call/FromTPCall/summary.json"),
                str(config["truvariResultsFolder"] + "/CuteSV-PAV-Sniffles-SVIM/DEL/Med/Call/FromTPBase/summary.json"),
                str(config["truvariResultsFolder"] + "/CuteSV-PAV-Sniffles-SVIM/INS/Med/Call/FromTPBase/summary.json"),
                str(config["truvariResultsFolder"] + "/CuteSV-PAV-Sniffles-SVIM/INV/Med/Call/FromTPBase/summary.json"),
                str(config["truvariResultsFolder"] + "/CuteSV-PAV-Sniffles-SVIM/DEL/Med/Base/FromTPCall/summary.json"),
                str(config["truvariResultsFolder"] + "/CuteSV-PAV-Sniffles-SVIM/INS/Med/Base/FromTPCall/summary.json"),
                str(config["truvariResultsFolder"] + "/CuteSV-PAV-Sniffles-SVIM/INV/Med/Base/FromTPCall/summary.json")
        output:
                str(config["truvariResultsFolder"] + "/CuteSV-PAV-Sniffles-SVIM/ALL/Med/Call/FromTPCall/tp-comp.sorted.vcf"),
                ...
                str(config["truvariResultsFolder"] + "/CuteSV-PAV-Sniffles-SVIM/ALL/Med/Call/FromTPBase/tp-comp.sorted.vcf"),
                ...
                str(config["truvariResultsFolder"] + "/CuteSV-PAV-Sniffles-SVIM/ALL/Med/Base/FromTPCall/tp-comp.sorted.vcf"),
...
rule combine_cuteSV_pav_svim_svim_asm_to_all_directory_Med:
        input:
                str(config["truvariResultsFolder"] + "/CuteSV-PAV-SVIM-SVIM-ASM/DEL/Med/Call/FromTPCall/summary.json"),
                str(config["truvariResultsFolder"] + "/CuteSV-PAV-SVIM-SVIM-ASM/INS/Med/Call/FromTPCall/summary.json"),
                str(config["truvariResultsFolder"] + "/CuteSV-PAV-SVIM-SVIM-ASM/INV/Med/Call/FromTPCall/summary.json"),
                str(config["truvariResultsFolder"] + "/CuteSV-PAV-SVIM-SVIM-ASM/DEL/Med/Call/FromTPBase/summary.json"),
                str(config["truvariResultsFolder"] + "/CuteSV-PAV-SVIM-SVIM-ASM/INS/Med/Call/FromTPBase/summary.json"),
                str(config["truvariResultsFolder"] + "/CuteSV-PAV-SVIM-SVIM-ASM/INV/Med/Call/FromTPBase/summary.json"),
                str(config["truvariResultsFolder"] + "/CuteSV-PAV-SVIM-SVIM-ASM/DEL/Med/Base/FromTPCall/summary.json"),
                str(config["truvariResultsFolder"] + "/CuteSV-PAV-SVIM-SVIM-ASM/INS/Med/Base/FromTPCall/summary.json"),
                str(config["truvariResultsFolder"] + "/CuteSV-PAV-SVIM-SVIM-ASM/INV/Med/Base/FromTPCall/summary.json")
        output:
                str(config["truvariResultsFolder"] + "/CuteSV-PAV-SVIM-SVIM-ASM/ALL/Med/Call/FromTPCall/tp-comp.sorted.vcf"),
                ...
                str(config["truvariResultsFolder"] + "/CuteSV-PAV-SVIM-SVIM-ASM/ALL/Med/Call/FromTPBase/tp-comp.sorted.vcf"),
                ...
                str(config["truvariResultsFolder"] + "/CuteSV-PAV-SVIM-SVIM-ASM/ALL/Med/Base/FromTPCall/tp-comp.sorted.vcf"),
...
rule combine_pav_sniffles_svim_svim_asm_to_all_directory_Med:
        input:
                str(config["truvariResultsFolder"] + "/PAV-Sniffles-SVIM-SVIM-ASM/DEL/Med/Call/FromTPCall/summary.json"),
                str(config["truvariResultsFolder"] + "/PAV-Sniffles-SVIM-SVIM-ASM/INS/Med/Call/FromTPCall/summary.json"),
                str(config["truvariResultsFolder"] + "/PAV-Sniffles-SVIM-SVIM-ASM/INV/Med/Call/FromTPCall/summary.json"),
                str(config["truvariResultsFolder"] + "/PAV-Sniffles-SVIM-SVIM-ASM/DEL/Med/Call/FromTPBase/summary.json"),
                str(config["truvariResultsFolder"] + "/PAV-Sniffles-SVIM-SVIM-ASM/INS/Med/Call/FromTPBase/summary.json"),
                str(config["truvariResultsFolder"] + "/PAV-Sniffles-SVIM-SVIM-ASM/INV/Med/Call/FromTPBase/summary.json"),
                str(config["truvariResultsFolder"] + "/PAV-Sniffles-SVIM-SVIM-ASM/DEL/Med/Base/FromTPCall/summary.json"),
                str(config["truvariResultsFolder"] + "/PAV-Sniffles-SVIM-SVIM-ASM/INS/Med/Base/FromTPCall/summary.json"),
                str(config["truvariResultsFolder"] + "/PAV-Sniffles-SVIM-SVIM-ASM/INV/Med/Base/FromTPCall/summary.json"),
        output:
                str(config["truvariResultsFolder"] + "/PAV-Sniffles-SVIM-SVIM-ASM/ALL/Med/Call/FromTPCall/tp-comp.sorted.vcf"),
                ...
                str(config["truvariResultsFolder"] + "/PAV-Sniffles-SVIM-SVIM-ASM/ALL/Med/Call/FromTPBase/tp-comp.sorted.vcf"),
                ...
                str(config["truvariResultsFolder"] + "/PAV-Sniffles-SVIM-SVIM-ASM/ALL/Med/Base/FromTPCall/tp-comp.sorted.vcf"),
...
rule combine_cuteSV_pav_sniffles_svim_asm_to_all_directory_Med:
        input:
                str(config["truvariResultsFolder"] + "/CuteSV-PAV-Sniffles-SVIM-ASM/DEL/Med/Call/FromTPCall/summary.json"),
                str(config["truvariResultsFolder"] + "/CuteSV-PAV-Sniffles-SVIM-ASM/INS/Med/Call/FromTPCall/summary.json"),
                str(config["truvariResultsFolder"] + "/CuteSV-PAV-Sniffles-SVIM-ASM/INV/Med/Call/FromTPCall/summary.json"),
                str(config["truvariResultsFolder"] + "/CuteSV-PAV-Sniffles-SVIM-ASM/DEL/Med/Call/FromTPBase/summary.json"),
                str(config["truvariResultsFolder"] + "/CuteSV-PAV-Sniffles-SVIM-ASM/INS/Med/Call/FromTPBase/summary.json"),
                str(config["truvariResultsFolder"] + "/CuteSV-PAV-Sniffles-SVIM-ASM/INV/Med/Call/FromTPBase/summary.json"),
                str(config["truvariResultsFolder"] + "/CuteSV-PAV-Sniffles-SVIM-ASM/DEL/Med/Base/FromTPCall/summary.json"),
                str(config["truvariResultsFolder"] + "/CuteSV-PAV-Sniffles-SVIM-ASM/INS/Med/Base/FromTPCall/summary.json"),
                str(config["truvariResultsFolder"] + "/CuteSV-PAV-Sniffles-SVIM-ASM/INV/Med/Base/FromTPCall/summary.json")
        output:
                str(config["truvariResultsFolder"] + "/CuteSV-PAV-Sniffles-SVIM-ASM/ALL/Med/Call/FromTPCall/tp-comp.sorted.vcf"),
                ...
                str(config["truvariResultsFolder"] + "/CuteSV-PAV-Sniffles-SVIM-ASM/ALL/Med/Call/FromTPBase/tp-comp.sorted.vcf"),
                ...
                str(config["truvariResultsFolder"] + "/CuteSV-PAV-Sniffles-SVIM-ASM/ALL/Med/Base/FromTPCall/tp-comp.sorted.vcf"),
