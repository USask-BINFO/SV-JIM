rule combine_all_callers_sizes_to_final_vcf:
        ...
        output:
                str(config["truvariResultsFolder"] + "/CuteSV-PAV-Sniffles-SVIM-SVIM-ASM/ALL/tp-comp.sorted.vcf"),
...
rule combine_cuteSV_sniffles_svim_svim_asm_sizes_to_final_vcf:
        ...
        output:
                ...
                str(config["truvariResultsFolder"] + "/CuteSV-Sniffles-SVIM-SVIM-ASM/ALL/Base/FromTPCall/tp-comp.sorted.vcf"),
...
rule combine_cuteSV_pav_sniffles_svim_to_final_vcf:
        ...
        output:
                ...
                str(config["truvariResultsFolder"] + "/CuteSV-PAV-Sniffles-SVIM/ALL/Base/FromTPCall/tp-comp.sorted.vcf"),
...
rule combine_cuteSV_pav_svim_svim_asm_to_final_vcf:
        ...
        output:
                ...
                str(config["truvariResultsFolder"] + "/CuteSV-PAV-SVIM-SVIM-ASM/ALL/Base/FromTPCall/tp-comp.sorted.vcf"),
...
rule combine_pav_sniffles_svim_svim_asm_to_final_vcf:
        ...
        output:
                ...
                str(config["truvariResultsFolder"] + "/PAV-Sniffles-SVIM-SVIM-ASM/ALL/Base/FromTPCall/tp-comp.sorted.vcf"),
...
rule combine_cuteSV_pav_sniffles_svim_asm_to_final_vcf:
        ...
        output:
                ...
                str(config["truvariResultsFolder"] + "/CuteSV-PAV-Sniffles-SVIM-ASM/ALL/Base/FromTPCall/tp-comp.sorted.vcf"),
